...
impl Token {
    ...
    pub fn span(&self) -> Span {
        match self.clone() {
            ...
            Token::B3Type { span, .. } => span,
            Token::B4Type { span, .. } => span,
            Token::B5Type { span, .. } => span,
            Token::B6Type { span, .. } => span,
            Token::B7Type { span, .. } => span,
            Token::B8Type { span, .. } => span,
            Token::B9Type { span, .. } => span,
            Token::B10Type { span, .. } => span,
            Token::B11Type { span, .. } => span,
            Token::B12Type { span, .. } => span,
            Token::B13Type { span, .. } => span,
            Token::B14Type { span, .. } => span,
            Token::B15Type { span, .. } => span,
            Token::B16Type { span, .. } => span,
            Token::B17Type { span, .. } => span,
            Token::B18Type { span, .. } => span,
            Token::B19Type { span, .. } => span,
            Token::B20Type { span, .. } => span,
            Token::B21Type { span, .. } => span,
            Token::B22Type { span, .. } => span,
            Token::B23Type { span, .. } => span,
            Token::B24Type { span, .. } => span,
            Token::B25Type { span, .. } => span,
            Token::B26Type { span, .. } => span,
            Token::B27Type { span, .. } => span,
            Token::B28Type { span, .. } => span,
            Token::B29Type { span, .. } => span,
            Token::B30Type { span, .. } => span,
            Token::B31Type { span, .. } => span,
