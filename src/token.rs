...
impl fmt::Display for TokenType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TokenType::UIntLit(ui) => write!(f, "{:?}", ui),
            TokenType::BigUIntLit(bui) => write!(f, "{:?}", bui),
            TokenType::ByteLit(b) => write!(f, "{:?}", b),
            ...
            TokenType::VecType { .. } => write!(f, "`Vec<T>`",),
            TokenType::MappingType { .. } => write!(f, "`Mapping<K, V>`"),
            TokenType::OptionType { .. } => write!(f, "`Option<T>`",),
            TokenType::ResultType { .. } => write!(f, "`Result<T, E>`",),
