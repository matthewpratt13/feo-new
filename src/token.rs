...
pub enum Token {
    ...
    Bytes2Literal { value: [u8; 2], span: Span },
    Bytes4Literal { value: [u8; 4], span: Span },
    Bytes8Literal { value: [u8; 8], span: Span },
    Bytes16Literal { value: [u8; 16], span: Span },
    Bytes32Literal { value: [u8; 32], span: Span },
    ...
    BytesType { name: String, span: Span },
